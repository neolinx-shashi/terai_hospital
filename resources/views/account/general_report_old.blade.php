            ...
            <div class="box">
                <div class="box-body">
                    <div class="col-md-12"></div>
                        ...
                        <form name="general-report" method="post" action="{{ url('/operate-general-report') }}">
                            {{ csrf_field() }}
                    ...
                    <table class="table table-striped" id="pathology-report">
                        ...
                        <?php $total_fee = $total_tax = $total_grand = 0; ?>
                            ...
                            <tr>
                                ...
                                <td>{{ $rep->patient_code }}</td>
                                <td>{{ $rep->title }}</td>
                                <td align="right">{{ $rep->test_price }} <?php $total_fee += $rep->test_price; ?></td>
                                <td align="right">{{ $rep->hst }} <?php $total_tax += $rep->hst; ?></td>
