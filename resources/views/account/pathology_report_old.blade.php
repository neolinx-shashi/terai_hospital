            ...
            <div class="box">
                <div class="box-body">
                    <div class="col-md-12"></div>
                        ...
                        <form name="pathology-report" method="post" action="{{ url('/operate-pathology-report') }}">
                            {{ csrf_field() }}
                    ...
                    <button id="print-report" class="btn btn-info pull-right" style="margin-left: 10px;"><i class="fa fa-print" aria-hidden="true"></i> Print</button> 

                    <button type="button" class="btn btn-info pull-right" id="excel"><span class="glyphicon glyphicon-save"></span> Export to Excel</button>
                    <div class="clearfix"></div>

                    <table class="table table-striped" id="pathology-report">
                        <thead>
                            <tr class="ninja h">
                                <th colspan="2">Pathology Report</th>
                                <th colspan="4" class="date-range"></th>
                            </tr>
                            <tr class="ninja h"><th colspan="8"></th></tr>
                            <tr>
                                <th>S.No.</th>
                                <th>Date</th>
                                <th>Doctor</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $rep->title }}</td>
                                <td align="right">{{ $rep->test_price }}</td>
                                <td align="right">{{ $rep->hst }}</td>
                                <td align="right">{{ $rep->gtotal }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<script>
    $(function () {
        ...
        $('#print-report').click(function() {
            $('#print-report, #submit, #excel').hide();
            window.print();
            $('#print-report, #submit, #excel').show();
        });
