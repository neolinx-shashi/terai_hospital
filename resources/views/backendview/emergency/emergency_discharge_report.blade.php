                        ...
                        <div class="tax-invoice">
                            <div class="logo text-center" style="margin-bottom:8px;">
                                ...
                                <div class="logo-area-text">
                                    ...
                                    <span style="font-size: 11px; text-align: center;   ">Emergency Discharge Report</span>
                                </div>
                            ...
                            <div class="body" style="margin-top: 0px; ">
                                <div class="print-left" style=" float: left; width: 60%; margin-right: 5px;">
                                   ...
                                   {{-- <p>Patient Code:<strong> {{$patient->patient_code}}</strong></p>
                                    ...
                                    <p>Doctor:
                                        <strong>Dr.{{$patient->belongsToDoctor->first_name}} 
                                        {{$patient->belongsToDoctor->middle_name}}
                                        {{$patient->belongsToDoctor->last_name}}</strong>
                                    </p>
                                     <p>Bed No:
                                        <strong>{{$patient->isOfBed->bed_name}}</strong>
                                    </p>
--}}
                                </div>
                                ...
                                <div class="test-invoice-total pull-right" style="margin-right:18px;">
                                    <p>Sub Total: <strong>&nbsp; Rs. {{ $billingDetail->sub_total}} </strong></p>
                                    ...
                                    <p>Discount : <strong>
                                            ...
                                            @else
                                                ...
                                                Rs. {{ $billingDetail->discount }}
                                            @endif
                                        </strong></p>

                                    @if($billingDetail->discount == 0)
                                        <p>Total: <strong>
                                     Rs. {{ $billingDetail->sub_total }} </strong></p>
                                    @else

                                        <p>Total: <strong>&nbsp;
                                         Rs. {{ $billingDetail->sub_total - $billingDetail->discount }} 
                                         </strong></p>
                                     @endif
                                    ...
                                    <p>G. Total: <strong>&nbsp; Rs. {{round($billingDetail->grand_total)}} </strong>
                                    </p>
                                </div>
                                ...
                                <div class="print-bottom total-calculation">
                                    <p class="in-words">In
                                        Words:<strong> {{convert_number_to_words(round($billingDetail->grand_total))}}
                                            Only</strong></p>
