<div class="panel panel-default department-add">
    ...
    <div class="panel-body">
        <form method="post" action="{{url('update-contact',array($edit->id))}}">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">

            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                <label for="name">Name <label class="text-danger">*</label></label>

                <input type="text" name="name" placeholder="Enter Contact Name" value="{{ $edit->name }}"
            ...
            <div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
                ...
                <input type="text" name="contact" placeholder="Enter Contact Number" value="{{ $edit->contact }}"
