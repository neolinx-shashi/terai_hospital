                ...
                <div class="box">
                    <div class="container">
                        <form class="doctor-form" method="post" onsubmit="return checkInp()"
                              action="{{URL::action('BackEndController\NurseController@store')}}"
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control" id="inputage" name="age"
                                                   placeholder="Age" value="{{old('age')}}" maxlength="3">
                                            @if($errors->has('age'))
                                                <span class="help-block" style="color: red">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" id="gender" name="gender">
                                                ...
                                                <option selected="selected" value="Female" @if(old('gender')=='Female') <?php echo 'selected' ?> @endif>
                                                    Female
                                                </option>
                                        ...
                                        <label for="faculty" class="col-sm-1 form-control-label">Department</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="designation" name="designation"
                                                   placeholder="Nurse Designation" value="{{old('designation')}}">
                                    ...
                                    <div class="form-group row">
                                        <label for="generalsymp" class="col-sm-1 form-control-label">
                                            Description</label>
                                        <div class="col-md-9">
            <textarea class="form-control col-md-5" id="generalsymp" name="nurse_description" rows="3" maxlength="150" placeholder="Only 150 character are allowed">  {{old('nurse_description')}}</textarea>
                                        </div>
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="reset" value="Reset" class="col-md-4 btn btn-warning btn-flat"
